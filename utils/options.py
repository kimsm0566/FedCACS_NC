...
def args_parser():
    ...
    parser.add_argument('--new', type=int, default=0, help="new flag")
    parser.add_argument('--multi_cats', type=int, default=1, help="use multi cats")
    parser.add_argument('--user_cat_list', type=int, default=5, help="a list of user's category list")
    parser.add_argument('--cos', type=int, default=1, help="use cos classifier or not")
    parser.add_argument('--novel_class_num', type=int, default=10, help="novel_class_num")
    parser.add_argument('--novel_users', type=int, default=10, help="number of novel users")
    parser.add_argument('--finetune_epochs', type=int, default=10, help="novel_epochs")
    ...
    parser.add_argument('--local_second_ep', type=int, default=1, help="the number of local epochs for the representation for FedRep")
